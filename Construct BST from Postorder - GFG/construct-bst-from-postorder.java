...
class GFG
{
    ...
    public  static Node construct(int[] post,int lr,int rr)
    {
        ...
        root.right=construct(post,root.data,rr);
        root.left=construct(post,lr,root.data);
    ...
    {
        idx=n-1;
        return construct(post,-(int)1e9+7,(int)1e9+7);
    }
}